    ...
    return(
      <Row>
        ...
        <Col span={20} class="container">
          ...
          <PCNewsImageBlock count={8} type="guonei" width="100%" cardTitle="国内头条" imageWidth="125px"/>
          <PCNewsImageBlock count={16} type="yule" width="100%" cardTitle="娱乐头条" imageWidth="125px"/>
        </Col>
        <Col span={2}></Col>
      </Row>
    );
